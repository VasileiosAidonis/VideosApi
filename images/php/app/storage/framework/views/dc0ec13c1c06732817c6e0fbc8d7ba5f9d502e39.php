...
<body style="background-image:linear-gradient(-90deg, #868686, #E6E6E6, black, #760C0C, black, #E6E6E6, #868686)">
  <div class="container" style="background-color: #E8E7E7; border-left:1px solid #A1A1A1; border-right:1px solid #A1A1A1;">
    ...
    <div class="d-flex">
        <div class="pl-1" style=""><img src="<?php echo e($video->image); ?>" decoding="async" style="height:70px; width:90px;"></div>
        <div class="h3 pt-4" style="margin-left: 50px;"> &#10077; <?php echo e($video->name); ?> &#10078; </div>
        <div class="h5 pt-4" style="padding-left: 500px;"><strong>Category </strong>: <?php echo e($video->category); ?></div>
    </div>
    ...
    <div class="pt-5 d-flex" style="padding-left:150px;">
       ...
       <div style="font-size:125%; padding-top:3px;">
          Because you watched a <strong><?php echo e($video->category); ?></strong> Video :
       </div>
       <div class="pt-0" style="font-size:120%;">
         <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <?php if(($video->category == $video_category) && ($video->name != $video_name)): ?>
              <div class="pt-1 d-flex" style="padding-left:25px;">
                    &#10148; &nbsp;
                 <div class="font-italic font-weight-bolder"><?php echo e($video->name); ?></div> &nbsp; &nbsp;
                 <div class="badge badge-primary text-wrap" style="width: 6rem;">
                    <a href="/videos1/<?php echo e($video->id); ?>" style="color:white;">
                        Watch Now
                    </a>
                 </div>
              </div>
